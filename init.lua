...
-- open vimrc
vim.keymap.set('n', '<leader>vv', ':e $MYVIMRC<CR> :cd %:h<CR>',
  { noremap = true, silent = true, desc = 'edit [V]im [R]C' })
...
vim.keymap.set('n', '<F3>', [[:redir @a<CR>:g//<CR>:redir END<CR>:vnew<CR>:put! a<CR>:set hlsearch<CR>]],
  { desc = 'redirect to new window last regex matches', silent = true })
-- insert time
